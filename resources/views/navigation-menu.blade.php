    ...
    <nav class="flex items-center bg-gray-900 px-3 py-2 shadow-lg">
        ...
        <div class="flex justify-end sm:w-8/12">
            ...
            <ul class="hidden sm:flex sm:text-left text-gray-200 text-xs">
                ...
                @endforeach --}}
                <a href="{{ url('/pages')}}">
                    <li class="cursor-pointer px-4 py-2 hover:bg-gray-800">{{ __("Pages") }}</li>
                </a>
            </ul>
        </div>
    </nav>
    <div class="sm:flex" :class ="show ? 'sm:min-h-screen' : 'sm:min-h-0'">
        <aside :class="show ? 'block' : 'hidden'" class="bg-gray-900 text-gray-700 divide-y divide-gray-700 divide-dashed sm:w-4/12 md:w-3/12 lg:w-2/12">
            {{-- Desktop Web View --}}
